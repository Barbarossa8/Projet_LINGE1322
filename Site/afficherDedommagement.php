...
<html lang="fr">
    ...
    <head>
        ...
        <title>Dédommagement 1322</title>
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <div class="description">
                            	<p>
                                    Cette page va vous afficher le dédommagement à donner au client selon le véhicule qu'il lui était promis.
                                </p>
                            </div>
                        </div>
                    </div>
                        	...
                        	<div class="form-box">
                        		<div class="form-top">
	                        		<div class="form-top-left">
	                        			<h3>Le montant</h3>
	                            		<p>Voici le montant à rendre au client :</p>
	                        		</div>
	                            ...
	                            <div class="form-bottom">
									...
									{
										echo '<li>'  . ' Le dédommagement pour ce véhicule est de : ' . $donnees['AmendeJour'] . ' EUR</li>';
									}
									echo '</ul>';
