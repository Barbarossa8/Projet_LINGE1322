...
<html lang="fr">
    ...
    <head>
        ...
        <title>Terminer réservation 1322</title>
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <div class="description">
                            	<p>
                                    Cette page va vous permettre d'entrer le numéro de la réservation afin de la terminée.
                                </p>
                            </div>
                        </div>
                    </div>
                        	...
                        	<div class="form-box">
                        		<div class="form-top">
	                        		<div class="form-top-left">
	                        			<h3>Terminer la réservation</h3>
	                            		<p>Entrer le nom de la réservation pour la modifier comme "termine" :</p>
	                        		</div>
	                            ...
	                            <div class="form-bottom">
                                    <form role="form" action="updateReservation.php" method="post" class="registration-form">

                                        <div class="form-group">
                                            <label class="form-title" for="form-numero-reservation">Le numéro de la réservation :</label>
                                            <input type="text" name="form-numero-reservation" placeholder="Ex: 1001" class="form-numero-reservation form-control" id="form-numero-reservation">
                                        </div>
