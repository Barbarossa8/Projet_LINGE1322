                        	...
                        	<div class="form-box">
                        		<div class="form-top">
	                        		<div class="form-top-left">
	                            		...
	                            		<p>Voici des filtres pour vous aider à choisir votre véhicule :</p>
	                        		</div>
	                            ...
	                            <div class="form-bottom">
                                    <form role="form" action="reserver.php" method="post" class="registration-form">
                                        ...
                                        <!--<div class="form-group">
                                            <label class="form-title" for="form-dedommagement">Le dédommagement :</label>
                                            <select name="form-dedommagement" id="form-dedommagement">
