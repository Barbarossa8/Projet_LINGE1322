                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <div class="description">
                            	<p>
                                    Cette page va vous afficher tout les clients de notre base de données.
                                </p>
                            </div>
                        </div>
                    </div>
                        	...
                        	<div class="form-box">
                        		<div class="form-top">
	                        		<div class="form-top-left">
	                        			<h3>Les clients</h3>
	                            		<p>Voici les clients actuels de notre base de données :</p>
	                        		</div>
	                            ...
	                            <div class="form-bottom">
									...
									{
										echo '<li>'  . ' <strong> NCLI : ' . $donnees['NCLI'] . '</strong><br />Nom : ' . $donnees['Nom'] . '<br />Prenom : ' . $donnees['Prenom'] . '<br />Adresse : ' . $donnees['Adresse'] . '<br />Numéro de permis : ' . $donnees['NumPermis'] . '</li>';
									}
									echo '</ul>';
