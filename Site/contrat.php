                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <div class="description">
                            	<p>
                                    Cette page va vous permettre d'entrer le numéro du véhicule afin d'imprimer son contrat par la suite.
                                </p>
                            </div>
                        </div>
                    </div>
                        	...
                        	<div class="form-box">
                        		<div class="form-top">
	                        		<div class="form-top-left">
	                        			<h3>Afficher un contrat</h3>
	                            		<p>Remplissez le formulaire pour afficher le contrat :</p>
	                        		</div>
	                            ...
	                            <div class="form-bottom">
                                    <form role="form" action="afficherContrat.php" method="post" class="registration-form">
                                        ...
                                        <div class="form-group">
                                            <label class="form-title" for="form-numero-client">Le numéro de client :</label>
                                            <input type="text" name="form-numero-client" placeholder="Ex: 11" class="form-numero-client form-control" id="form-numero-client">
                                        </div>
